...
export class ColorLogger {
     ...
     */
    static setTags(tag: LogType = LogType.DEFAULT) {
        this.tags = tag;
    }
     ...
     * @param describe  标题描述
     */
    static logDefault(msg: any,
                      describe?: string) {
        this.print(LogType.DEFAULT, msg, "", describe)
    }
     ...
     * @param describe  标题描述
     */
    static logView(msg: any,
                   describe?: string) {
        this.green(LogType.View, msg, describe);
    }

    /** 打印配置日志 */
    static logConfig(msg: any,
                     describe?: string) {
        this.gray(LogType.Config, msg, describe);
    }

    // 橙色
    private static orange(tag: LogType,
                          msg: any,
                          describe?: string) {
    ...
    // 紫色
    private static violet(tag: LogType,
                          msg: any,
                          describe?: string) {
    ...
    // 蓝色
    private static blue(tag: LogType,
                        msg: any,
                        describe?: string) {
    ...
    // 绿色
    private static green(tag: LogType,
                         msg: any,
                         describe?: string) {
    ...
    // 灰色
    private static gray(tag: LogType,
                        msg: any,
                        describe?: string) {
     ...
     */
    private static print(tag: LogType,
                         msg: any,
                         color: string,
                         describe?: string) {
        // 标记没有打开，不打印该日志
